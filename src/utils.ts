import { NoIdPatient, Gender, EntryWithoutId } from "../types";
...
const toNewPatientType = (object: unknown): NoIdPatient => {
...
const parseSpecialist = (value: unknown): string => {
  if (!value || !isString(value)) {
...
const toNewEntryType = (object: unknown): EntryWithoutId  => {
 if (!object || typeof object !== 'object') {
